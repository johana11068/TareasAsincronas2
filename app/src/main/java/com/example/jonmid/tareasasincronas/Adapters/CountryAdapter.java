...
public class CountryAdapter extends RecyclerView.Adapter<CountryAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View item) {
            ...
            textViewCountry = (TextView) item.findViewById(R.id.id_tv_country);
            textViewAlpha2 = (TextView) item.findViewById(R.id.id_tv_alpha2);
            textViewAlpha3 = (TextView) item.findViewById(R.id.id_tv_alpha3);
        }
    }
}
